...
class ExerciseViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        var toolbarY = CGRectGetMaxY(self.view.frame) - toolbarHeight
        var toolbar = UIToolbar(frame: CGRect(x: 0, y: toolbarY, width: CGRectGetWidth(self.view.frame), height: toolbarHeight))
